  ...
  return (
    <main className="min-h-screen bg-[#F8F9FC]">
      ...
      <section className="relative overflow-hidden border-b border-[#E4E4EF]">
        <div className="pointer-events-none absolute left-[-10%] top-[-20%] h-[460px] w-[460px] rounded-full bg-[#ECEBFF]/70 blur-[120px]" />
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-[#D4D5E0] bg-white/86 px-4 py-2 shadow-[0_16px_42px_rgba(15,23,42,0.07)] backdrop-blur-xl">
                <LockKeyhole size={14} className="text-[#5659D9]" />
                <span className="text-[11px] font-[700] uppercase tracking-[0.18em] text-[#191A2E]">Privacy first</span>
              </div>
              <h1 className="mt-6 max-w-[640px] text-[42px] font-[700] leading-[0.96] tracking-normal text-[#191A2E] sm:text-[60px]">
                ...
                <div className="mt-7 grid gap-3">
                  {trustPoints.map((point) => (
                    <div key={point} className="flex items-start gap-3 rounded-2xl bg-white/8 px-4 py-3">
                      <FileCheck2 size={16} className="mt-0.5 flex-shrink-0 text-[#A5A7FF]" />
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-6 lg:py-20">
        <div className="grid gap-5 lg:grid-cols-2">
          {privacySections.map((section) => (
            <article key={section.title} className="rounded-[32px] border border-[#E4E4EF] bg-white p-6 shadow-[0_14px_40px_rgba(15,23,42,0.045)]">
              <div className="flex items-start gap-4">
                <div className="flex h-13 w-13 h-[52px] w-[52px] flex-shrink-0 items-center justify-center rounded-3xl bg-[#ECEBFF] text-[#5659D9]">
                  {section.icon}
                </div>
                <div>
                  <h2 className="text-[21px] font-[700] tracking-normal text-[#191A2E]">{section.title}</h2>
        ...
        <div className="mt-6 rounded-[34px] border border-[#E4E4EF] bg-white p-6 shadow-soft lg:p-8">
          <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <h2 className="text-[26px] font-[700] tracking-normal text-[#191A2E]">Need help with privacy?</h2>
              <p className="mt-3 max-w-2xl text-[14px] leading-[1.8] text-[#62657A]">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <a href="mailto:privacy@mobpae.com" className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-[#7679FF] px-5 text-[13px] font-[700] text-white transition hover:bg-[#5659D9]">
                <Mail size={15} /> privacy@mobpae.com
              </a>
              <a href="tel:+919227012145" className="inline-flex h-12 items-center justify-center rounded-full border border-[#D4D5E0] bg-[#F0F0F8] px-5 text-[13px] font-[700] text-[#191A2E] transition hover:bg-[#ECEBFF]">
                +91 92270 12145
              </a>
            </div>
          </div>
