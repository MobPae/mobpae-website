          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-white/86 px-4 py-2 shadow-[0_16px_42px_rgba(15,23,42,0.07)] backdrop-blur-xl">
                ...
                <span className="text-[11px] font-[700] uppercase tracking-[0.18em] text-emerald-800">Privacy first</span>
              </div>
              <h1 className="mt-6 max-w-[640px] text-[42px] font-[700] leading-[0.96] tracking-normal text-slate-950 sm:text-[60px]">
            ...
            <div className="rounded-[38px] border border-white bg-white/82 p-5 shadow-soft backdrop-blur-xl">
              <div className="rounded-[30px] bg-slate-950 p-6 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[12px] font-[700] uppercase tracking-[0.14em] text-emerald-100/60">MobPae trust layer</p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-6 lg:py-20">
          ...
          {privacySections.map((section) => (
            <article key={section.title} className="rounded-[32px] border border-emerald-100 bg-white p-6 shadow-[0_14px_40px_rgba(15,23,42,0.045)]">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-[21px] font-[700] tracking-normal text-slate-950">{section.title}</h2>
        ...
        <div className="mt-6 rounded-[34px] border border-emerald-100 bg-white p-6 shadow-soft lg:p-8">
          <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <h2 className="text-[26px] font-[700] tracking-normal text-slate-950">Need help with privacy?</h2>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <a href="mailto:privacy@mobpae.com" className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-slate-950 px-5 text-[13px] font-[700] text-white transition hover:bg-emerald-700">
                <Mail size={15} /> privacy@mobpae.com
              </a>
              <a href="tel:+919227012145" className="inline-flex h-12 items-center justify-center rounded-full border border-emerald-200 bg-emerald-50 px-5 text-[13px] font-[700] text-emerald-800 transition hover:bg-emerald-100">
                +91 92270 12145
              </a>
            </div>
          </div>
