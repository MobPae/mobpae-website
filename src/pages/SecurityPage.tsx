          ...
          <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-white/86 px-4 py-2 shadow-[0_16px_42px_rgba(15,23,42,0.07)] backdrop-blur-xl">
                ...
                <span className="text-[11px] font-[700] uppercase tracking-[0.18em] text-emerald-800">Security & trust</span>
              </div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a href="/privacy-policy" className="group inline-flex h-12 items-center justify-center gap-2 rounded-full bg-slate-950 px-6 text-[14px] font-[700] text-white shadow-[0_22px_54px_rgba(15,23,42,0.24)] transition-all hover:-translate-y-1 hover:bg-emerald-700">
                  Read privacy policy <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" />
                </a>
                <a href="/for-employers" className="inline-flex h-12 items-center justify-center rounded-full border border-emerald-200 bg-white/86 px-6 text-[14px] font-[700] text-slate-900 shadow-[0_16px_36px_rgba(15,23,42,0.06)] backdrop-blur-xl transition-all hover:-translate-y-1 hover:text-emerald-800">
                  For employers
                </a>
              </div>
            </div>
            ...
            <div className="rounded-[40px] border border-white bg-white/84 p-5 shadow-soft backdrop-blur-xl">
              <div className="rounded-[32px] bg-slate-950 p-6 text-white">
                <div className="flex items-start justify-between gap-5">
                  <div>
                    <p className="text-[12px] font-[700] uppercase tracking-[0.14em] text-emerald-100/60">Trust architecture</p>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          <div className="mb-12 max-w-3xl">
            <p className="text-[11px] font-[700] uppercase tracking-[0.22em] text-emerald-700">Trust layers</p>
          ...
          <div className="grid gap-5 md:grid-cols-2">
            {trustLayers.map((layer) => (
              <article key={layer.title} className="rounded-[32px] border border-emerald-100 bg-[#F6F9F8] p-6 shadow-[0_12px_34px_rgba(15,23,42,0.035)]">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-[22px] font-[700] tracking-normal text-slate-950">{layer.title}</h3>
