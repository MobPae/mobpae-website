          ...
          <div className="grid gap-12 lg:grid-cols-[0.86fr_1.14fr] lg:items-center">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-[#D4D5E0] bg-white/86 px-4 py-2 shadow-[0_16px_42px_rgba(15,23,42,0.07)] backdrop-blur-xl">
                <Sparkles size={14} className="text-[#5659D9]" />
                <span className="text-[11px] font-[700] uppercase tracking-[0.18em] text-[#191A2E]">Careers at MobPae</span>
              </div>

              <h1 className="mt-6 max-w-[680px] text-[42px] font-[700] leading-[0.96] tracking-normal text-[#191A2E] sm:text-[64px]">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  href="#roles"
                  className="group inline-flex h-12 items-center justify-center gap-2 rounded-full bg-[#7679FF] px-6 text-[14px] font-[700] text-white shadow-[0_22px_54px_rgba(15,23,42,0.24)] transition-all hover:-translate-y-1 hover:bg-[#5659D9]"
                >
                  Explore roles
            ...
            <div className="relative min-h-[500px]">
              ...
              <div className="absolute inset-x-3 bottom-8 top-0 overflow-hidden rounded-[40px] border border-white/40 bg-white shadow-[0_34px_90px_rgba(15,23,42,0.18)] lg:inset-x-8">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#ECEBFF]/35 via-transparent to-white/10" />
              ...
              <div className="absolute right-0 top-14 rounded-full border border-white/70 bg-white/90 px-4 py-2 text-[12px] font-[700] text-[#191A2E] shadow-soft backdrop-blur-xl">
      ...
      <section className="bg-white py-18 lg:py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          <div className="grid gap-5 lg:grid-cols-3">
            {principles.map((item) => (
              <div key={item} className="rounded-[30px] border border-[#E4E4EF] bg-[#F8F9FC] p-6">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#ECEBFF] text-[#5659D9]">
                  <Users size={21} />
                </div>
                <p className="mt-5 text-[24px] font-[700] leading-tight tracking-normal text-[#191A2E]">{item}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="roles" className="bg-[#F8F9FC] py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          <div className="mb-10 flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
            <div>
              <p className="text-[11px] font-[700] uppercase tracking-[0.22em] text-[#5659D9]">Open tracks</p>
              <h2 className="mt-4 text-[36px] font-[700] leading-[1] tracking-normal text-[#191A2E] lg:text-[48px]">
                Where you can build.
              </h2>
            </div>
            <p className="max-w-[420px] text-[14px] leading-[1.8] text-[#62657A]">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {roles.map((role) => (
              <article key={role.name} className="group rounded-[34px] border border-[#E4E4EF] bg-white p-6 shadow-[0_14px_40px_rgba(15,23,42,0.045)] transition-all hover:-translate-y-1 hover:shadow-soft">
                <div className="flex h-14 w-14 items-center justify-center rounded-3xl bg-[#ECEBFF] text-[#5659D9]">
                  {role.icon}
                </div>
                <h3 className="mt-6 text-[24px] font-[700] tracking-normal text-[#191A2E]">{role.name}</h3>
                <p className="mt-3 text-[14px] leading-[1.8] text-[#62657A]">{role.desc}</p>
                <a href="mailto:careers@mobpae.com" className="mt-6 inline-flex items-center gap-2 text-[13px] font-[700] text-[#5659D9] transition-all group-hover:gap-3">
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          <div className="grid gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
            <div>
              <p className="text-[11px] font-[700] uppercase tracking-[0.22em] text-[#5659D9]">Why MobPae</p>
              <h2 className="mt-4 text-[36px] font-[700] leading-[1] tracking-normal text-[#191A2E] lg:text-[48px]">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              {benefits.map((benefit) => (
                <div key={benefit.title} className="rounded-[32px] border border-[#E4E4EF] bg-[#F8F9FC] p-6 shadow-[0_12px_34px_rgba(15,23,42,0.035)]">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#7679FF] text-white">
                    {benefit.icon}
                  </div>
                  <h3 className="mt-5 text-[20px] font-[700] tracking-normal text-[#191A2E]">{benefit.title}</h3>
                  <p className="mt-3 text-[13.5px] leading-[1.75] text-[#62657A]">{benefit.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="light-feature-panel mt-14 rounded-[36px] p-7 lg:p-9">
            <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
              ...
              <a
                href="mailto:careers@mobpae.com"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-white px-6 text-[14px] font-[700] text-[#191A2E] transition hover:-translate-y-1 hover:bg-[#F0F0F8]"
              >
...
function HeroMetric({ value, label }: { value: string; label: string }) {
  return (
    <div className="rounded-2xl bg-white/72 px-4 py-3">
      <p className="text-[20px] font-[700] leading-none tracking-normal text-[#191A2E]">{value}</p>
