    ...
    <main className="min-h-screen bg-[#F6F9F8]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-[72vh] max-w-5xl flex-col items-center justify-center px-5 py-20 text-center sm:px-6">
          ...
          <p className="mt-8 text-[12px] font-[700] uppercase tracking-[0.22em] text-emerald-700">404</p>
          <h1 className="mt-4 max-w-3xl text-[42px] font-[700] leading-[0.96] tracking-normal text-slate-950 sm:text-[64px]">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link to="/" className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-slate-950 px-6 text-[14px] font-[700] text-white transition hover:-translate-y-1 hover:bg-emerald-700">
              <Home size={16} /> Go home
            </Link>
            <Link to="/contact" className="inline-flex h-12 items-center justify-center gap-2 rounded-full border border-emerald-200 bg-white/86 px-6 text-[14px] font-[700] text-slate-900 shadow-[0_16px_36px_rgba(15,23,42,0.06)] transition hover:-translate-y-1 hover:text-emerald-800">
