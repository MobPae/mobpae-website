  ...
  return (
    <div className="mpw-home">
      ...
      <main id="main-content">
        <section className="mpw-404">
          <div className="mpw-rail">
            <div className="mpw-404__art">
              <NotFoundIllustration />
            </div>
            <span className="mpw-page-hero__eyebrow">404</span>
            <h1>This page moved.</h1>
            <p>
              The page you are looking for does not exist yet or may have
              been renamed.
            </p>
            <div className="mpw-page-hero__actions">
              <Link to="/" className="mpw-btn">
                Go Home <ArrowRight size={16} aria-hidden="true" />
              </Link>
            </div>
            <nav className="mpw-404-links" aria-label="Suggested pages">
