...
export function LaunchReadySections() {
  return (
    <>
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          <div className="mb-10 max-w-3xl">
            <p className="text-[11px] font-[700] uppercase tracking-[0.22em] text-[#214be6]">Who this is for</p>
      ...
      <section className="bg-[#F8F9FC] py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          <div className="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
            <div>
              <p className="text-[11px] font-[700] uppercase tracking-[0.22em] text-[#214be6]">MVP onboarding</p>
              <h2 className="mt-4 text-[36px] font-[700] leading-[1] tracking-normal text-[#111827] lg:text-[48px]">
              ...
              <div className="grid gap-3">
                {timeline.map((item, index) => (
                  <div key={item} className="flex items-center gap-4 rounded-[24px] bg-[#F8F9FC] px-4 py-4">
                    <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-2xl bg-[#315eff] text-[12px] font-[700] text-white">
                      {index + 1}
                    </span>
                    <p className="text-[15px] font-[700] text-[#111827]">{item}</p>
                    <CheckCircle2 size={18} className="ml-auto flex-shrink-0 text-[#315eff]" />
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          <div className="rounded-[38px] border border-[#dce5ff] bg-[#f1f5ff] p-7 text-[#111827] shadow-[0_22px_60px_rgba(49,94,255,0.12)] lg:p-9">
            <div className="grid gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-center">
              <div>
                <p className="text-[12px] font-[700] uppercase tracking-[0.16em] text-[#214be6]">Trust positioning</p>
...
function TrustRow({ icon, text }: { icon: React.ReactNode; text: string }) {
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-white bg-white/72 px-4 py-4">
      <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-2xl bg-[#E9F6F6] text-[#214be6]">{icon}</span>
